        ...
        <span>
            ...
            {item.martial === "Yes" && (
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 408.98 412.19" width="15"height="15">
                <g id="martialFilled" data-name="martialFilled"> <path className="martialFilled" d="M380.29,206.1c-69,33.4-137.3,100.5-175.8,178-38.5-77.5-106.8-144.6-175.8-178C97.69,172.7,165.99,105.6,204.49,28.1c38.5,77.5,106.8,144.6,175.8,178Z"></path> </g>
              </svg>
            )}
          </span>
